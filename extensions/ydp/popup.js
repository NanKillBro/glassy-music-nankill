...
function initializeDocument(tab) {
    ...
    chrome.runtime.getPlatformInfo(function(info) {
        if (info.os != "win") {
            ...
            chrome.storage.local.get("isNativeConnected", function (result) {
                if (result.isNativeConnected == false) {
                    ...
                    chrome.storage.local.get("nativeVersionStatus", function (result) {
                        if (result.nativeVersionStatus == -1) {
                            ...
                            chrome.storage.local.get("minimizeVersionWarning", function (result) {
    ...
    // FLASH EDIT PRESENCE
    chrome.storage.local.get("flashEditPresence", function (result) {
    ...
    chrome.storage.local.get("enableOnStartup", function (result) {
    ...
    if (tab.url.startsWith(YOUTUBE_MAIN_URL) || tab.url.startsWith(YOUTUBE_MUSIC_URL)) {
        chrome.storage.local.get("tabEnabledList", function (result) {
    ...
    chrome.storage.local.get("enableExclusions", function (result) {
    ...
    chrome.storage.local.get("enableInclusions", function (result) {
    ...
    chrome.storage.local.get("videoExclusionsList", function (result) {
    ...
    chrome.storage.local.get("keywordExclusionsList", function (result) {
    ...
    chrome.storage.local.get("videoInclusionsList", function (result) {
    ...
    chrome.storage.local.get("keywordInclusionsList", function (result) {
    ...
    chrome.storage.local.get("enableYouTube", function (result) {
    ...
    chrome.storage.local.get("enableYouTubeMusic", function (result) {
    ...
    chrome.storage.local.get("enableVideoButton", function (result) {
    ...
    chrome.storage.local.get("enableChannelButton", function (result) {
    ...
    chrome.storage.local.get("enablePlayingIcon", function (result) {
    ...
    chrome.storage.local.get("addByAuthor", function (result) {
    ...
    chrome.storage.local.get("useThumbnailIcon", function (result) {
    ...
    chrome.storage.local.get(["nativeVersion", "nativeVersionStatus", "isNativeConnected"], function (result) {
